  ...
  return (
    <div className='justify-starts flex flex-col items-start'>
      <div className='grid grid-cols-[auto,1fr] grid-rows-[auto,auto] items-center gap-2 py-2'>
        ...
        <Image alt='밥팟 로고' src={BabPulImage} className='col-start-1 row-start-2 aspect-square w-6 self-start' />
        <div className='relative col-start-2 row-start-2 rounded-lg bg-rcChatGray px-4 py-3 text-xs'>
          <div
